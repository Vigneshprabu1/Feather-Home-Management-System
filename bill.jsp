            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="houseownername" value='<%=milk%>' readonly />
                        </div>
                        ...
                        <button type="button"  class="btn btn-danger" onclick="location.href='GridDisplay.jsp'" id="submit">Back</button></center>
